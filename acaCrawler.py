...
def search_starter(search_text):
    ...
    base_url = update_url(search, page_number, starting_article)
    ...
    return (total_n_pages, base_url)

def update_loop(limiter, base_url, total_n_pages):
...
if __name__ == "__main__":
    ...
    # Recover values from starter function
    total_n_pages, base_url = search_starter(search_text)
    ...
    all_articles = update_loop(limiter, base_url, total_n_pages)
